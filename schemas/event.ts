...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "string",
      description:
        "This is a shorter name for the location (if possible) and will appear on the Event Card component.",
    }),
    defineField({
      name: "location",
    ...
    defineField({
      ...
      type: "string",
      description:
        "This should be to help people find the address on Google Maps",
    }),
    defineField({
      ...
      type: "datetime",
      description:
        "This is when the event page will display the Application Box for users to apply for the event",
    }),
    defineField({
      ...
      type: "string",
      description:
        "This will be shown in the Lead Box. Use the format 'MM/DD/YYYY'",
    }),
    defineField({
      name: "subheadline",
    ...
    defineField({
      ...
      description:
        "This will appear in the browser tab and search results, No longer than 60 characters.",
    }),
    defineField({
      ...
      description:
        "This will appear in search results, No longer than 160 characters.",
    }),
    defineField({
      name: "cld_id",
    ...
    defineField({
      ...
      type: "string",
      description:
        "THIS CANNOT CHANGE ONCE SET. Will be used to collect leads before people are able to register.",
    }),
  ],
});
