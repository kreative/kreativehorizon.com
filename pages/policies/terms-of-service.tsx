      ...
      <main>
        ...
        <Container>
          <div className="pt-12 max-w-full lg:max-w-[75%] mx-auto text-xl">
            <h2 className="font-chedros text-4xl pt-6">Terms and Conditions</h2>
            ...
            <h2 className="font-chedros text-4xl pt-6">Acknowledgment</h2>
            <p className="py-3">
            ...
            <h2 className="font-chedros text-4xl pt-6">Termination</h2>
            <p className="py-3">
            ...
            <h2 className="font-chedros text-4xl pt-6">Governing Law</h2>
            <p className="py-3">
            ...
            <h2 className="font-chedros text-4xl pt-6">Disputes Resolution</h2>
            <p className="py-3">
            ...
            <h2 className="font-chedros text-4xl pt-6">Severability</h2>
            <p className="py-3">
            ...
            <h2 className="font-chedros text-4xl pt-6">Waiver</h2>
            <p className="py-3">
