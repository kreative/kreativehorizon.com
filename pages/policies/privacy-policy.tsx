      ...
      <main>
          ...
          <div className="bg-gradient-to-b from-horizon-tan to-transparent">
            <Container>
              <div className="pt-32 md:py-16 min-h-[25rem] lg:min-h-[30rem] flex flex-col justify-end items-center space-y-4">
                <h3 className="text-2xl tracking-wide font-guthen">
                  Our Policies
                </h3>
                <h3 className="text-6xl md:text-7xl font-chedros text-center">
                  Privacy Policy
                </h3>
              </div>
            </Container>
        ...
        <Container>
          <div className="pt-12 max-w-full lg:max-w-[75%] mx-auto text-xl">
            ...
            <h2 className="font-chedros text-4xl pt-6">
              Interpretation and Definitions
            </h2>
            <h2 className="font-chedros text-4xl pt-6">Interpretation</h2>
            <p className="py-3">
            ...
            <h2 className="font-chedros text-4xl pt-6">Definitions</h2>
            <p className="py-3">For the purposes of this Privacy Policy:</p>
            <ul className="pl-3 list-disc space-y-3 py-6">
              ...
              <li>
                <p className="py-3">
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Kreative, LLC.,
                  3012 Blazingstar Court, Naperville, IL 60564.
                </p>
              </li>
              <li>
                <p className="py-3">
              ...
              <li>
                <p className="py-3">
                  <strong>Website</strong> refers to Kreative Horizon,
                  accessible from{" "}
                  <a
            ...
            <ul className="pl-3 list-disc space-y-3 py-6">
              ...
              <li>
                <p className="py-3">First name and last name</p>
              </li>
              <li>
                <p className="py-3">Phone number</p>
              </li>
              <li>
                <p className="py-3">Usage Data</p>
              </li>
            </ul>
            <h3>Usage Data</h3>
            <p className="py-3">
            ...
            <ul className="pl-3 list-disc space-y-3 py-6">
              <li>
                ...
                <p className="py-3">Type: Session Cookies</p>
                <p className="py-3">Administered by: Us</p>
                <p className="py-3">
              ...
              <li>
                ...
                <p className="py-3">Type: Persistent Cookies</p>
                <p className="py-3">Administered by: Us</p>
                <p className="py-3">
            ...
            <h2 className="font-chedros text-4xl pt-6">Contact Us</h2>
            <p className="py-3">
              ...
              <li>
                <p className="py-3">
                  ...
                  <a
                    ...
                    className="underline text-horizon-purple font-bold"
                  >
                    https://kreativehorizon.com/contact-us
                  </a>
                </p>
              </li>
              <li>
