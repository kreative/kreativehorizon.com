...
export const meta = {
  ...
  date: "2023-09-06",
  title:
    "HackIowaState v2: The Ultimate Hackathon Experience Returns to Iowa State University",
  description:
    "Kreative Horizon is excited to announce the return of HackIowaState v2, the ultimate student invention competition experience at Iowa State University.",
};
