...
export default function EventPageTemplate({
  ...
  const leadBoxSuccess = router.query?.lead_success && router.query.lead_success === "true";
      ...
      <main>
        <Container>
          <div className="max-w-5xl mx-auto pt-12 pb-32">
            ...
            {leadBoxSuccess &&
                <div className={"mt-8"}>
                  <SuccessAlert message={"You're in! We'll reach out when you can register."} />
                </div>
            }
            <div className="pt-12 grid grid-cols-12 gap-6">
              ...
              <div className="col-span-12 lg:col-span-4">
                {Date.now() < new Date(event.registration_opens_date).getTime() &&
                    <div id={"lead-box"} className="p-8 bg-horizon-grey-100 rounded-2xl">
                      <h2 className="text-3xl font-chedros text-center mb-3">
                        Registration will be opening on {event.registration_opens_date_label}
                      </h2>
                      <p className="text-horizon-grey-700 font-md text-center">
                        We&apos;ll let you know when registration opens so you don&apos;t miss your spot.
                      </p>
                      <div className="mt-6">
                        <form
                ...
                {Date.now() >= new Date(event.registration_opens_date).getTime() &&
                    <div id={"app-box"} className="p-8 bg-horizon-grey-100 rounded-2xl">
                      <h2 className="text-3xl font-chedros text-center mb-3">
