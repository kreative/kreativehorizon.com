  ...
  return (
    <Container>
      ...
      <div className="flex flex-wrap space-x-4 sm:space-x-6 space-y-4 md:space-y-0 justify-center items-center">
        <Image
          src={"https://res.cloudinary.com/dlazo25rt/image/upload/v1689576316/kreativehorizon.com/sponsors/1PASSWORD_kqtllc.webp"}
        ...
        />
        <LogoImage
          src={"https://res.cloudinary.com/dlazo25rt/image/upload/v1689576316/kreativehorizon.com/sponsors/WOLFRAM_LANGUAGE_ehmj6t.webp"}
          alt="Wolfram Language Logo in Color"
          w="244"
          h="99"
        />
        <LogoImage
          src={"https://res.cloudinary.com/dlazo25rt/image/upload/v1690764265/kreativehorizon.com/sponsors/Color-ISURP-Logo_2022-1_xg70hq.webp"}
          alt="Iowa State University Research Park Logo in Color"
          w="818"
          h="199"
        />
        <LogoImage
          src={"https://res.cloudinary.com/dlazo25rt/image/upload/v1689576316/kreativehorizon.com/sponsors/TECHNEXUS_gwqk9q.webp"}
          alt="Technexus Logo in Color"
          w="259"
          h="72"
        />
        <Image
          src={"https://res.cloudinary.com/dlazo25rt/image/upload/v1689576316/kreativehorizon.com/sponsors/JETBRAINS_ljme47.webp"}
        ...
        />
        <LogoImage
          src={"https://res.cloudinary.com/dlazo25rt/image/upload/v1689576316/kreativehorizon.com/sponsors/LINODE_calb1c.webp"}
        ...
        />
        <LogoImage
          src={"https://res.cloudinary.com/dlazo25rt/image/upload/v1690764264/kreativehorizon.com/sponsors/Visionary-4PMS-2.75IN_fgsaxz.webp"}
          alt="Visionary Media Logo in Color"
          w="818"
          h="199"
        />
        <LogoImage
          src={"https://res.cloudinary.com/dlazo25rt/image/upload/v1689576316/kreativehorizon.com/sponsors/AMBIDEXTER_ocblfh.webp"}
          alt="Ambidexter Logo in Color"
          w="316"
          h="55"
        />
        <LogoImage
          src={"https://res.cloudinary.com/dlazo25rt/image/upload/v1692329529/kreativehorizon.com/sponsors/maple-studios-horizontal-min_tggyad.webp"}
